...
public class AboutActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView1.loadData("<center><h1>"+getString(R.string.app_name)+"</h1><h2>Šimkovič Peter<br/>CHS PK Cavies<br/><a href=\"mailto:info@chs-pk-cavies.eu\">info@chs-pk-cavies.eu</a></h2></center><h4 style=\"text-align:justify\">Ide o veľmi jednoduchú aplikáciu na orientačný výpočet dátumu pôrodu u morčiat. Stačí zadať dátum nakrytia, alebo oddelenia a následne aplikácia zobrazí tri dátumy. 1. najskorší termín, 2. optimálny a 3. najneskorší termín pôrodu. Samozrejme, ide čisto o štatistické výpočty a realita sa môže líšiť od vypočítaných dátumov. Verím, že vám táto aplikácia zjednoduší život a uľahčí často vykonávané operácie ako je výpočet dátumu pôrodu.</h4><br/>"+s, "text/html; charset=UTF-8", null);
    }
}
